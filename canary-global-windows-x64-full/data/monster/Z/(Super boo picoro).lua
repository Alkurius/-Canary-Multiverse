local mType = Game.createMonsterType("(Super boo picoro)")
local monster = {}

monster.description = "a super boo picoro"
...
monster.loot = {
    ...
    {name = "death's shadow helmet", chance = 1900},
    {name = "legendary warrior shield", chance = 490},
    {name = "pharaonic rod (Earth)", chance = 1160},
    {name = "divine axe", chance = 240},
    {name = "Vegeta armor", chance = 890}
}
