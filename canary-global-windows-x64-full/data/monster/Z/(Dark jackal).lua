local mType = Game.createMonsterType("(Dark jackal)")
local monster = {}

monster.description = "a dark jackal"
...
monster.loot = {
    ...
    {name = "gold coin", chance = 57500, maxCount = 61},
    {name = "platinum coin", chance = 1105, maxCount = 3},
    {name = "crown helmet", chance = 766},
    {name = "meat", chance = 57500, maxCount = 5},
    {id = 6299, chance = 288},
    {name = "bar of chocolate", chance = 322},
    {name = "diamond sceptre", chance = 391},
    {name = "shadow sceptre", chance = 310},
    {name = "focus cape", chance = 391},
    {name = "crystal of focus", chance = 115},
    {name = "essence of a bad dream", chance = 8846},
    {name = "scythe leg", chance = 5475},
