local mType = Game.createMonsterType("(Water master)")
local monster = {}

monster.description = "a water master"
...
monster.loot = {
    ...
    {name = "terra rod", chance = 53750},
    {name = "snakebite rod", chance = 26212},
    {name = "cobra crest", chance = 20162},
    {name = "terra hood", chance = 17138},
    {name = "cyan crystal fragment", chance = 13506},
    {name = "terra boots", chance = 12100},
    {id = 281, chance = 11088},
