local mType = Game.createMonsterType("(Arcane skeleton)")
local monster = {}

monster.description = "a arcane skeleton"
monster.experience = 5500
monster.health = 3900
monster.maxHealth = 3900
monster.race = "undead"
monster.corpse = 39934
monster.speed = 370
monster.manaCost = 0
monster.raceId = 2506
...
monster.loot = {
    {name = "gold coin", chance = 100000, maxCount = 342},
    {name = "platinum coin", chance = 6760, maxCount = 5},
    {id = 3046, chance = 6305},
    {name = "dark shield", chance = 3900},
    {name = "scythe", chance = 11700},
    {name = "orichalcum pearl", chance = 1820, maxCount = 5},
    {id = 6299, chance = 429},
    {name = "demonic essence", chance = 13780},
    {name = "flask of demonic blood", chance = 45500},
    {name = "nightmare blade", chance = 1144},
    {name = "great mana potion", chance = 13000},
    {name = "glacier kilt", chance = 429},
    {name = "ultimate health potion", chance = 12480},
    {name = "skullcracker armor", chance = 351},
    {name = "underworld rod", chance = 1183},
    {id = 8896, chance = 3250},
    {name = "mystical hourglass", chance = 6890},
