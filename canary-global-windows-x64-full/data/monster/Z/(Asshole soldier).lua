local mType = Game.createMonsterType("(Asshole soldier)")
local monster = {}

monster.description = "a asshole soldier"
...
monster.loot = {
    {id = 3147, chance = 14960, maxCount = 2},
    {id = 3031, chance = 100000, maxCount = 219},
    {id = 3347, chance = 16368, maxCount = 6},
    {id = 3035, chance = 37279, maxCount = 3},
    {id = 7378, chance = 12551, maxCount = 6},
    {id = 236, chance = 11385, maxCount = 2},
    {id = 237, chance = 11682, maxCount = 2},
    {id = 5944, chance = 8173},
    {id = 5878, chance = 5533},
    {id = 11472, chance = 5192, maxCount = 2},
    {id = 3030, chance = 2904, maxCount = 3},
    {id = 3033, chance = 2838, maxCount = 3},
    {id = 3049, chance = 2442},
    {id = 5912, chance = 1837},
    {id = 5910, chance = 1562},
    {id = 5911, chance = 1496},
