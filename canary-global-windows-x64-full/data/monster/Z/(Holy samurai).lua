local mType = Game.createMonsterType("(Holy samurai)")
local monster = {}

monster.description = "a holy samurai"
...
monster.loot = {
    ...
    {name = "ogre boots", chance = 1090},
    {name = "centurion hammer", chance = 1910},
    {name = "heart boots", chance = 1660}
}
