local mType = Game.createMonsterType("(Earth devil)")
local monster = {}

monster.description = "a earth devil"
...
monster.loot = {
    {name = "small stone", chance = 12000, maxCount = 12},
    {name = "gold coin", chance = 51600, maxCount = 120},
    {name = "gold coin", chance = 60000, maxCount = 36},
    {name = "blank rune", chance = 12000},
    {name = "strong mana potion", chance = 2292},
    {name = "earth arrow", chance = 24192, maxCount = 36},
    {id = 8894, chance = 420},
    {name = "small topaz", chance = 744},
    {name = "lump of earth", chance = 24552},
    {name = "clay lump", chance = 684},
    {id = 12600, chance = 564},
