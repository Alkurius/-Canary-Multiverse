local mType = Game.createMonsterType("(Charged saiyan ape)")
local monster = {}

monster.description = "a charged saiyan ape"
...
monster.loot = {
    ...
    {id = 8074, chance = 1215},
    {id = 3340, chance = 540},
    {name = "meteoro earth backpack", chance = 1630},
    {name = "great emerald", chance = 2140},
    {name = "ultimate holy rune", chance = 3300},
    {name = "samurai helmet", chance = 870},
    {name = "corrupted demon armor", chance = 1940},
    {name = "ancestral esmeralda crossbow", chance = 590}
}
