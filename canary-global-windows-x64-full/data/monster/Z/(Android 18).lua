local mType = Game.createMonsterType("(Android 18)")
local monster = {}

monster.description = "a android 18"
...
monster.loot = {
    ...
    {name = "plague boots", chance = 1000},
    {name = "nightmare club", chance = 270},
    {name = "decay rod", chance = 660},
