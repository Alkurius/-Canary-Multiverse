local mType = Game.createMonsterType("(Ogre smasher)")
local monster = {}

monster.description = "a ogre smasher"
monster.experience = 2000
monster.health = 2200
monster.maxHealth = 2200
monster.race = "blood"
monster.corpse = 41314
monster.speed = 350
monster.manaCost = 0
monster.raceId = 2440
...
monster.loot = {
    ...
    {id = 3035, chance = 20020, maxCount = 6},
    {id = 3725, chance = 2200},
    {id = 7643, chance = 2431},
    {id = 236, chance = 1320},
    {id = 22053, chance = 2090},
    {id = 22087, chance = 1045},
    {id = 22054, chance = 858},
    {id = 7439, chance = 770},
    {id = 7432, chance = 396},
    {id = 3081, chance = 473},
