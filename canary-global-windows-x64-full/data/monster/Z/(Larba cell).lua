local mType = Game.createMonsterType("(Larba cell)")
local monster = {}

monster.description = "a larba cell"
...
monster.loot = {
    ...
    {id = 3059, chance = 6736},
    {name = "terra rod", chance = 688},
    {name = "two handed sword", chance = 5332},
    {name = "morning star", chance = 9477},
    {name = "longsword", chance = 12231},
    {name = "steel shield", chance = 5373},
    {name = "bonelord shield", chance = 148},
    {name = "bonelord eye", chance = 1364},
    {name = "mana potion", chance = 405},
    {name = "small flask of eyedrops", chance = 6831}
}
