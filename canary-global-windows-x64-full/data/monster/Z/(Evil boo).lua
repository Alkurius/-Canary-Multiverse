local mType = Game.createMonsterType("(Evil boo)")
local monster = {}

monster.description = "a evil boo"
...
monster.loot = {
    ...
    {name = "helmet of infinity flames", chance = 2130},
    {name = "royal shield", chance = 180},
    {name = "pharaonic rod (Energy)", chance = 1800},
    {name = "helmet of RA", chance = 1530},
