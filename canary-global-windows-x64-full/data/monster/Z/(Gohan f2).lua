local mType = Game.createMonsterType("(Gohan f2)")
local monster = {}

monster.description = "a gohan f2"
...
monster.loot = {
    ...
    {name = "plague bow", chance = 1650},
    {name = "warlock armor", chance = 1580},
    {name = "black wizard rod", chance = 750},
