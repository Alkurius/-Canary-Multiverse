local mType = Game.createMonsterType("(Holy cotton pet)")
local monster = {}

monster.description = "a holy cotton pet"
...
monster.loot = {
    {id = 2829, chance = 3172},
    {name = "small oil lamp", chance = 932},
    {name = "small sapphire", chance = 3456, maxCount = 5},
    {name = "gold coin", chance = 81000, maxCount = 94},
    {name = "gold coin", chance = 94500, maxCount = 61},
    {name = "mystic turban", chance = 94},
    {id = 3595, chance = 31698},
    {name = "blue rose", chance = 594},
    {name = "blue piece of cloth", chance = 2592},
    {name = "royal spear", chance = 6075, maxCount = 3},
    {name = "mana potion", chance = 1161},
    {name = "dirty turban", chance = 2552}
}
