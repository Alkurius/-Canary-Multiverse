local mType = Game.createMonsterType("(Freeza)")
local monster = {}

monster.description = "a freeza"
...
monster.loot = {
    ...
    {name = "gold coin", chance = 54000, maxCount = 131},
    {name = "gold coin", chance = 4576, maxCount = 9},
    {name = "small amethyst", chance = 3038, maxCount = 4},
    {id = 3049, chance = 3648},
    {name = "necrotic rod", chance = 1120},
    {name = "blank rune", chance = 22499, maxCount = 3},
    {name = "double axe", chance = 2692},
    {id = 3307, chance = 7641},
    {name = "guardian shield", chance = 10976},
    {name = "pitchfork", chance = 67500},
    {name = "cleaver", chance = 11920},
    {name = "soul orb", chance = 9760},
    {id = 6299, chance = 162},
    {name = "demonic essence", chance = 10800},
    {name = "flask of demonic blood", chance = 33750, maxCount = 3},
    {name = "magma coat", chance = 338},
    {name = "magma monocle", chance = 580},
