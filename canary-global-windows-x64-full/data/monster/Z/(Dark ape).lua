local mType = Game.createMonsterType("(Dark ape)")
local monster = {}

monster.description = "a dark ape"
...
monster.loot = {
    ...
    {name = "great mana potion", chance = 29997, maxCount = 3},
    {name = "terra amulet", chance = 20142},
    {name = "dark mushroom", chance = 18441, maxCount = 8},
    {name = "green mushroom", chance = 19656, maxCount = 7},
    {name = "garlic necklace", chance = 2268},
    {name = "bat wing", chance = 2092, maxCount = 3},
