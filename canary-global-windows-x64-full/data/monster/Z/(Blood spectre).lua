local mType = Game.createMonsterType("(Blood spectre)")
local monster = {}

monster.description = "a blood spectre"
monster.experience = 4830
monster.health = 5175
monster.maxHealth = 5175
monster.race = "blood"
...
monster.loot = {
    ...
    {name = "Brown Crystal Splinter", chance = 1260},
    {name = "Red Crystal Fragment", chance = 11900},
    {name = "Small Enchanted Ruby", chance = 10500},
    {name = "Small Diamond", chance = 8400},
    {name = "Small Sapphire", chance = 7000},
