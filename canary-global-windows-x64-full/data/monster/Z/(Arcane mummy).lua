local mType = Game.createMonsterType("(Arcane mummy)")
local monster = {}

monster.description = "a arcane mummy"
...
monster.loot = {
    {name = "Platinum Coin", chance = 56550, maxCount = 20},
    {id = 3115, chance = 65000},
    {name = "white mushroom", chance = 31200, maxCount = 4},
    {name = "Soul Orb", chance = 56550, maxCount = 6},
    {name = "Knight Axe", chance = 4225},
    {name = "pelvis bone", chance = 3419, maxCount = 13},
    {name = "Unholy Bone", chance = 3419, maxCount = 6},
    {name = "Skull Helmet", chance = 455},
    {name = "Ruthless Axe", chance = 195},
