local mType = Game.createMonsterType("(Silverback ape)")
local monster = {}

monster.description = "a silverback ape"
...
monster.loot = {
    {name = "small diamond", chance = 1013, maxCount = 4},
    {name = "gold coin", chance = 40500, maxCount = 135},
    {name = "gold coin", chance = 40500, maxCount = 135},
    {name = "gold coin", chance = 40500, maxCount = 40},
    {name = "crossbow", chance = 7992},
    {id = 3449, chance = 10328, maxCount = 14},
    {name = "dragon ham", chance = 46980, maxCount = 4},
    {name = "dragonbone staff", chance = 148},
    {name = "strong health potion", chance = 26960},
    {name = "strong mana potion", chance = 20668},
    {name = "lightning pendant", chance = 972},
    {name = "composite hornbow", chance = 122},
    {name = "focus cape", chance = 1688},
    {name = "hibiscus dress", chance = 338},
    {name = "wand of starstorm", chance = 567},
    {name = "wand of draconia", chance = 1336},
    {name = "shockwave amulet", chance = 148},
    {name = "wyrm scale", chance = 20736},
