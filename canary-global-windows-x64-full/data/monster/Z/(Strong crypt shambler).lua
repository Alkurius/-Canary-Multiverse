local mType = Game.createMonsterType("(Strong crypt shambler)")
local monster = {}

monster.description = "a strong crypt shambler"
monster.experience = 644
monster.health = 977
monster.maxHealth = 977
monster.race = "undead"
monster.corpse = 39943
monster.speed = 220
monster.manaCost = 0
monster.raceId = 2831
