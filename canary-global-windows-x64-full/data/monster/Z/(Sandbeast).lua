local mType = Game.createMonsterType("(Sandbeast)")
local monster = {}

monster.description = "a sandbeast"
...
monster.loot = {
    ...
    {name = "great mana potion", chance = 28886, maxCount = 3},
    {name = "terra amulet", chance = 19396},
    {name = "dark mushroom", chance = 17758, maxCount = 8},
    {name = "green mushroom", chance = 18928, maxCount = 6},
    {name = "garlic necklace", chance = 2184},
    {name = "bat wing", chance = 2015, maxCount = 3},
