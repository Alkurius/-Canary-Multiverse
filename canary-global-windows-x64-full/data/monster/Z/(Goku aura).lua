local mType = Game.createMonsterType("(Goku aura)")
local monster = {}

monster.description = "a goku aura"
...
monster.loot = {
    ...
    {name = "Mana Backpack", chance = 1210},
    {name = "crystal emerald", chance = 1890},
    {name = "ultimate missile holy rune", chance = 4030},
    {name = "empire helmet", chance = 730},
    {name = "pit demon boots", chance = -20},
    {name = "club of the dark lord", chance = 1660},
    {name = "Iluminati boots", chance = 1650},
    {name = "Goku armor", chance = 470}
}
