local mType = Game.createMonsterType("(Strong yakon)")
local monster = {}

monster.description = "a strong yakon"
monster.experience = 4510
monster.health = 3410
monster.maxHealth = 3410
monster.race = "blood"
...
monster.loot = {
    {id = 3031, chance = 100000, maxCount = 339},
    {id = 3035, chance = 25480, maxCount = 8},
    {id = 7368, chance = 2800, maxCount = 3},
    {id = 3027, chance = 2800},
    {id = 6558, chance = 2800},
    {id = 6499, chance = 3094},
    {id = 3028, chance = 1120, maxCount = 4},
    {id = 3032, chance = 1260, maxCount = 4},
    {id = 3030, chance = 910, maxCount = 4},
    {id = 3029, chance = 812, maxCount = 4},
    {id = 9057, chance = 812, maxCount = 4},
    {id = 239, chance = 980},
    {id = 3026, chance = 784},
    {id = 7404, chance = 182},
    {id = 3041, chance = 448},
