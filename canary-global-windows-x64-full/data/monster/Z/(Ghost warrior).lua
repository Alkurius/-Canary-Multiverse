local mType = Game.createMonsterType("(Ghost warrior)")
local monster = {}

monster.description = "a ghost warrior"
monster.experience = 5175
monster.health = 8970
...
monster.loot = {
    {name = "Platinum Coin", chance = 60900, maxCount = 21},
    {id = 3115, chance = 70000},
    {name = "white mushroom", chance = 33600, maxCount = 4},
    {name = "Soul Orb", chance = 60900, maxCount = 7},
    {name = "Knight Axe", chance = 4550},
    {name = "pelvis bone", chance = 3682, maxCount = 14},
    {name = "Unholy Bone", chance = 3682, maxCount = 7},
    {name = "Skull Helmet", chance = 490},
    {name = "Ruthless Axe", chance = 210},
