local mType = Game.createMonsterType("(Glaciar yeti)")
local monster = {}

monster.description = "a glaciar yeti"
monster.experience = 736
monster.health = 1520
monster.maxHealth = 1520
monster.race = "blood"
monster.corpse = 41248
monster.speed = 300
monster.manaCost = 0
monster.raceId = 2407
...
monster.loot = {
    {name = "snowball", chance = 16000, maxCount = 35},
    {name = "gold coin", chance = 100000, maxCount = 96},
    {name = "gold coin", chance = 100000, maxCount = 64},
    {name = "bunnyslippers", chance = 2133},
    {name = "meat", chance = 53333, maxCount = 6},
    {name = "ham", chance = 16000, maxCount = 8},
    {name = "semi-perfect opalo", chance = 2330},
    {name = "Cyclops Doll", chance = 1650},
