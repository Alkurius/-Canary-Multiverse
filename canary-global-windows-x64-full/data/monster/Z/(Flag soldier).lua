local mType = Game.createMonsterType("(Flag soldier)")
local monster = {}

monster.description = "a flag soldier"
...
monster.loot = {
    ...
    {name = "Platinum Coin", chance = 4455, maxCount = 2},
    {name = "Fox Paw", chance = 4455, maxCount = 2},
    {name = "Werefox Tail", chance = 4455, maxCount = 2},
    {name = "Strong Mana Potion", chance = 4455, maxCount = 2},
    {name = "Great Mana Potion", chance = 4455, maxCount = 2},
    {name = "Mana Potion", chance = 4455, maxCount = 2},
    {name = "Small Enchanted Emerald", chance = 4455, maxCount = 2},
    {name = "Emerald Bangle", chance = 4455, maxCount = 2},
    {name = "Moonlight Rod", chance = 550},
    {name = "Troll Green", chance = 550, maxCount = 2},
    {name = "Assassin Star", chance = 330, maxCount = 6},
    {name = "Platinum Amulet", chance = 143},
    {id = 3098, chance = 220},
    {name = "Werewolf Amulet", chance = 55},
    {id = 27706, chance = 33},
