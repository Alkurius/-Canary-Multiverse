local mType = Game.createMonsterType("(Frost drake)")
local monster = {}

monster.description = "a frost drake"
monster.experience = 2645
monster.health = 2875
monster.maxHealth = 2875
monster.race = "undead"
monster.corpse = 41179
monster.speed = 262
monster.manaCost = 0
monster.raceId = 2379
