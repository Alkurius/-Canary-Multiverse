local mType = Game.createMonsterType("(Fire chocobo)")
local monster = {}

monster.description = "a fire chocobo"
...
monster.loot = {
    ...
    {name = "lost demon club", chance = 1310},
    {name = "club of eternal winter", chance = 30},
    {name = "glaciar armor", chance = 900}
}
