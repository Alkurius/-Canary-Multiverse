...
function Player:onGainExperience(source, exp, rawExp)
	...
	-- Epic rings
	if getPlayerSlotItem(self, CONST_SLOT_AMMO).itemid == 40492 then exp = exp * 2 end
	if getPlayerSlotItem(self, CONST_SLOT_AMMO).itemid == 40493 then exp = exp * 5 end
	if getPlayerSlotItem(self, CONST_SLOT_AMMO).itemid == 40494 then exp = exp * 10 end
